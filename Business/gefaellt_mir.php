...
if (isset($_SESSION['login']) && $_SESSION['login'] == 1) {
    ...
    if ($schonmal_bewertet == 1) {
        if ($wie_bewertet == 1) {
            ...
            <?php echo $plus; ?>
            <a href="../index.php?folder=Data&page=gefaellt_mir_auswertung.php&how=0&new=0&id=<?php echo $nachrichten_id; ?>" class="like_button_down">-</a> 
            <?php echo $minus; ?>
            ...
            <a href="../index.php?folder=Data&page=gefaellt_mir_auswertung.php&how=1&new=0&id=<?php echo $nachrichten_id; ?>" class="like_button_up">+</a> 
            <?php echo $plus; ?>
        ...
        <a href="../index.php?folder=Data&page=gefaellt_mir_auswertung.php&how=1&new=1&id=<?php echo $nachrichten_id; ?>" class="like_button_up">+</a> 
        <?php echo $plus; ?>
        <a href="../index.php?folder=Data&page=gefaellt_mir_auswertung.php&how=0&new=1&id=<?php echo $nachrichten_id; ?>" class="like_button_down">+</a> 
        <?php echo $minus; ?>
